...
# 1. Implement the d-th operation mode and apply it to DES. 
# 2. Encrypt your name using DES with the implemented operation mode. 

# This code use existing Python module `pycryptodome`
...
def des_encrypt(input_data, key):
    ...
    ct_bytes = cipher.encrypt(pad(input_data, DES.block_size))
    return ct_bytes
...
def main():
    ...
    # Get the DES key from user input
